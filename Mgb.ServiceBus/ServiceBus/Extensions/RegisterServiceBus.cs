...
public static class ServiceBus
{
        ...
        IConfiguration configuration)
    {
        ...
        var messageRoutes = assemblies
            ...
            .Select(t => new { Type = t, Attr = t.GetCustomAttribute<EventAttribute>() })
    ...
    private static IDictionary<string, Type> BuildRemoteNameToLocalTypeMap()
    {
        ...
        return assemblies
            ...
            .Where(x => x.Attr is { RemoteTypeFullName: not null })
            .ToDictionary(x => x.Attr!.RemoteTypeFullName!, x => x.t, StringComparer.Ordinal);
    }
}